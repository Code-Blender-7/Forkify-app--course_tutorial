...
export class RecipeView {
  ...
  render(data) {
    this.#data = data; // stores API data as a object variable property
    this.#clear();
  ...
  #clear() {
    this.#parentElement.innerHTML = ""; // clear HTML
  }
  ...
  renderError(message = this.#errorMessage) {
    ...
    this.#clear();
    this.#parentElement.insertAdjacentHTML("afterbegin", error_markup);
  }
    ...
    return `  
      ...
      <div class="recipe__ingredients">
        ...
        <ul class="recipe__ingredient-list">
          ${this.#data.ingredients // code refactored. check below
